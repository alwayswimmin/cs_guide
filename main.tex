...
\node[myrect=16]
  (array1)
  {
  					\strut $b$
  \nodepart{two}	\strut $e$
  \nodepart{three}	\strut $h$
  \nodepart{four}	\strut $h$
  \nodepart{five}	\strut $i$
  \nodepart{six}	\strut $i$
  \nodepart{seven}	\strut $e$
  \nodepart{eight}	\strut $b$
  \nodepart{nine}	\strut $c$
  \nodepart{ten}	\strut $c$
  \nodepart{eleven}	\strut $d$
  \nodepart{twelve}	\strut $f$
  \nodepart{thirteen}	\strut $f$
  \nodepart{fourteen}	\strut $g$
  \nodepart{fifteen}	\strut $g$
  \nodepart{sixteen}	\strut $d$
  };
\foreach \Valor [count=\Valori from 1] in {one ,two ,three , four , five , six , seven , eight , nine , ten , eleven , twelve , thirteen , fourteen , fifteen , sixteen }
  \node[below] at (array1.\Valor south) {\Valori};
